...
date: 2020-11-1
languages: [Kanuri, Hausa, Swahili, Lingala, Nande, Rohingya, Tigrinya, English, French]
---
```
...
- [Gamayun kit dataset on Hugging Face](https://huggingface.co/datasets/CLEAR-Global/Gamayun-kits)
